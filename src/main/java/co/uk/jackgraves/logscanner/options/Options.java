package co.uk.jackgraves.logscanner.options;
...
/**
 * Add the given non-value option to <i>all</i> known sets.
 * See {@link OptionSet#addOption(String, Multiplicity)} for details.
 */
 ...
 * See {@link OptionSet#addOption(String, Separator)} for details.
 */
...
/**
 * Add the given value option to <i>all</i> known sets.
 * See {@link OptionSet#addOption(String, Separator, Multiplicity)} for details.
 */
...
/**
 * Add the given value option to <i>all</i> known sets.
 * See {@link OptionSet#addOption(String, boolean, Separator)} for details.
 */
...
/**
 * Add the given value option to <i>all</i> known sets.
 * See {@link OptionSet#addOption(String, boolean, Separator, Multiplicity)} for details.
 */
